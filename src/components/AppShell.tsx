  ...
  return <div className="app-shell">
    ...
    <header className="app-header store-header capsule-store-header">
      <div className="header-capsule shell-width">
        <Link className="brand brand-logo capsule-brand" href="/biblioteca" aria-label="LeituraVerso — início"><img src="/leituraverso-logo-light-v2.svg" alt="LEITURAVERSO"/></Link>
