...
type Tab="editar"|"pedidos"|"categorias"|"usuarios"|"drive";
...
export function AdminDashboard({initialBooks,initialCategories,initialProfiles,initialRequests}:Props){
  ...
  const tabs:[Tab,string][]=[["pedidos",`Pedidos (${pendingRequests.length})`],["editar","Editar livros"],["categorias","Categorias"],["usuarios","Usuários"],["drive","Google Drive"]];
  return <>
